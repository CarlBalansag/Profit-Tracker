...
export const PIPELINE_CARD_REGISTRY = {
  ...
  SHIPPED:         { label: 'Shipped',         icon: Send,            color: 'yellow' },
  DELIVERED:       { label: 'Delivered',       icon: Package,         color: 'orange' },
  SCANNED_IN:      { label: 'Scanned In',      icon: ScanLine,        color: 'amber' },
  PAID:            { label: 'Paid',            icon: CircleCheck,     color: 'green' },
  LISTED:          { label: 'Listed',          icon: ListChecks,      color: 'purple' },
  SOLD:            { label: 'Sold',            icon: DollarSign,      color: 'green' },
  COMPLETED:       { label: 'Completed',       icon: CircleCheck,     color: 'emerald' },
  RETURNED:        { label: 'Returned',        icon: Undo2,           color: 'red' },
  DISPUTED:        { label: 'Disputed',        icon: AlertTriangle,   color: 'orange' },
  CANCELLED:       { label: 'Cancelled',       icon: XCircle,         color: 'rose' },
  PENDING_PAYMENT: { label: 'Pending Pay',     icon: Hourglass,       color: 'amber' },
  IN_TRANSIT_OUT:  { label: 'Shipping Out',    icon: Truck,           color: 'blue' },
  AUTHENTICATION:  { label: 'Authenticating',  icon: Shield,          color: 'purple' },
};
...
export const DEFAULT_DASHBOARD_SETTINGS = {
  ...
  pipelineCards: [
    ...
    { id: 'DELIVERED',       visible: true,  order: 3 },
    { id: 'SCANNED_IN',      visible: true,  order: 4 },
    { id: 'PAID',            visible: true,  order: 5 },
    { id: 'LISTED',          visible: true,  order: 6 },
    { id: 'SOLD',            visible: true,  order: 7 },
    { id: 'COMPLETED',       visible: true,  order: 8 },
    { id: 'RETURNED',        visible: false, order: 9 },
    { id: 'DISPUTED',        visible: false, order: 10 },
    { id: 'CANCELLED',       visible: false, order: 11 },
    { id: 'PENDING_PAYMENT', visible: false, order: 12 },
    { id: 'IN_TRANSIT_OUT',  visible: false, order: 13 },
    { id: 'AUTHENTICATION',  visible: false, order: 14 },
  ],
  chartSeries: [
    { id: 'totalCost',    visible: true,  order: 0 },
    { id: 'grossProfit',  visible: true,  order: 1 },
