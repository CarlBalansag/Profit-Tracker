...
const Login = () => {
  ...
  const faqs = [
    { q: 'Is this free to use?', a: signupEnabled ? 'Yes — Profit Tracker is free during its current phase. Create an account with a real email, verify it, then sign in.' : 'Yes — Profit Tracker is free during its current phase. Returning accounts can sign in; new registration is not open yet.' },
    ...
    <div className="min-h-screen bg-[#07070a] text-white overflow-x-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <section id="how" className="py-24 px-5 sm:px-8 border-t border-white/[0.05]">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10">
            {[
              { n: '1', icon: LogIn, title: 'Sign in to your account', body: 'Use your verified email and private password. Your records stay with your account.' },
      ...
      <section className="py-24 px-5 sm:px-8 border-t border-white/[0.05]">
        <div className="max-w-lg mx-auto text-center">
          ...
          <p className="text-[14px] text-white/35 mb-8">Sign in with your email and password.</p>
          <button
            onClick={handleLogin}
